      ...
      <div id="content">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row">
                    <div class="col-sm-6">
                       <h2 class="m-0 font-weight-bold text-primary">Unit Kerja BPK</h2>
                    </div>
                    <div class="col-sm-6" align="right">
                        <a href="tambah_bpk.php" class="btn btn-success">Tambah</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr align="center">
                      ...
                      <td width="20%">LOKASI KEGIATAN</td>
                      <td width="15%">TINGKAT ESELON</td>
                      <td width="15%">AKSI</td>
                    </tr>
                  </thead>
                  <tfoot>
                  ...
                  <tbody>
                    <tr align="center"> 
                      ...
                      <td><?php echo $isi['unit_kerja'];?></td>
                      <td><?php echo $isi['lokasi_kegiatan'];?></td>
                      <td><?php echo $isi['tingkat_eselon'];?></td>
                      <td>
                          <?php echo"<a href='edit_bpk.php?id=$isi[0]' class='btn btn-success'>Edit</a>";?>
                          <?php echo"<a href='hapus_bpk.php?id=$isi[0]' class='btn btn-danger'>Hapus</a>";?>
                      </td>
                    </tr>
                  </tbody>
                        <?php } ?>
