      ...
      <div id="content">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row">
                    <div class="col-sm-6">
                       <h2 class="m-0 font-weight-bold text-primary">Unit Kerja TI</h2>
                    </div>
                    <div class="col-sm-6" align="right">
                        <a href="tambah_ti.php" class="btn btn-success">Tambah</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr align="center">
                      ...
                      <td width="20%">SINGKATAN</td>
                      <td width="15%">ID UNKER PARENT</td>
                      <td width="15%">AKSI</td>
                    </tr>
                  </thead>
                  <tfoot>
                  ...
                  <tbody>
                    <tr align="center"> 
                      ...
                      <td>
                          <?php echo"<a href='edit_ti.php?id=$isi[0]' class='btn btn-success'>Edit</a>";?>
                          <?php echo"<a href='hapus_ti.php?id=$isi[0]' class='btn btn-danger'>Hapus</a>";?>
                      </td>
                    </tr>
                  </tbody>
                        <?php } ?>
