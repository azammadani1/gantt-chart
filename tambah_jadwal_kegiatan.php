    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
            <div class="col-lg-12">
                <h1 align="center">Tambah Jadwal Kegiatan</h1>
                <img src="" class="headerimg">
                <form action="simpan_jadwal_kegiatan.php" method="post" name="">
                <table border="0" width="600" align="center">
                    ...
                    <tr>
                        <td class="lead">ID Tema Kegiatan</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><input class="form-control" id="inputSuccess" type="date" name="tanggal_mulai" size="20" maxlength="30"/></td>
                    </tr>
                    <tr>
                        <td class="lead">Tanggal Selesai</td>
                        <td><input class="form-control" id="inputSuccess" type="date" name="tanggal_selesai" size="20" maxlength="15"/></td>
                    </tr>
                    <tr>
