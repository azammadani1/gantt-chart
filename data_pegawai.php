      ...
      <div id="content">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row">
                    <div class="col-sm-6">
                       <h2 class="m-0 font-weight-bold text-primary">Pegawai</h2>
                    </div>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr align="center">
                      <td width="5%">NO.</td>
                      <td width="10%">ID</td>
                      <td width="10%">NIP LAMA</td>
                      <td width="10%">NIP BARU</td>
                      <td width="20%">NAMA</td>
                      <td width="5%">GOLONGAN</td>
                      <td width="10%">ID UNIT KERJA TI</td>
                      <td width="10%">ID KEGIATAN</td>
                      <td width="20%">AKSI</td>
                    </tr>
                  </thead>
                  <tfoot>
                  ...
                  <tbody>
                    <tr align="center"> 
                      ...
                      <td>
                          <?php echo"<a href='edit_pegawai.php?id=$isi[0]' class='btn btn-success'>Edit</a>";?>
                          <?php echo"<a href='hapus_pegawai.php?id=$isi[0]' class='btn btn-danger'>Hapus</a>";?>
                      </td>
                    </tr>
                  </tbody>
                        <?php } ?>
