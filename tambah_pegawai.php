      ...
      <div id="content">
        ...
        <div id="page-wrapper">
            ...
            <div class="col-lg-12">
                ...
                <form action="simpan_pegawai.php" method="post" name="">
                <table border="0" width="600" align="center">
                    ...
                    <tr>
                        ...
                        <td><input class="form-control" id="inputSuccess" type="text" name="nip_lama" size="20" maxlength="20"/></td>
                    </tr>
                    <tr>
                        <td class="lead">NIP Baru</td>
                        <td><input class="form-control" id="inputSuccess" type="text" name="nip_baru" size="20" maxlength="20"/></td>
                    </tr>
                    <tr>
                        <td class="lead">Nama</td>
                        <td><input class="form-control" id="inputSuccess" type="text" name="nama" size="20" maxlength="30"/></td>
                    </tr>
                    <tr>
                        <td class="lead">Golongan</td>
                        <td><input class="form-control" id="inputSuccess" type="text" name="golongan" size="20" maxlength="15"/></td>
                    </tr>
                        <tr>
