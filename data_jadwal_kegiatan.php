      ...
      <div id="content">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row">
                    <div class="col-sm-6">
                       <h2 class="m-0 font-weight-bold text-primary">Jadwal Kegiatan</h2>
                    </div>
                    <div class="col-sm-6" align="right">
                        <a href="tambah_jadwal_kegiatan.php" class="btn btn-success">Tambah</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr align="center">
                      <td width="5%">NO.</td>
                      <td width="8%">ID</td>
                      <td width="8%">ID JENIS KEGIATAN</td>
                      <td width="8%">ID TEMA KEGIATAN</td>
                      <td width="15%">TANGGAL BERANGKAT</td>
                      <td width="15%">TANGGAL PULANG</td>
                      <td width="8%">ID UNIT KERJA BPK</td>
                      <td width="10%">AKSI</td>
                    </tr>
                  </thead>
                  <tfoot>
                  ...
                  <tbody>
                    <tr align="center"> 
                      ...
                      <td>
                          <?php echo"<a href='edit_jadwal_kegiatan.php?id=$isi[0]' class='btn btn-success'>Edit</a>";?>
                          <?php echo"<a href='hapus_jadwal_kegiatan.php?id=$isi[0]' class='btn btn-danger'>Hapus</a>";?>
                      </td>
                    </tr>
                  </tbody>
                        <?php } ?>
