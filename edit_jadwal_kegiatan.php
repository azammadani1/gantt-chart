<?php
  ...
  $cari="select * from jadwal_kegiatan where id='$cid'";
      ...
      <li class="nav-item active">
        ...
        <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="data_jadwal_kegiatan.php">Jadwal Kegiatan</a>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
            <div class="col-lg-12">
                <h1 align="center">Edit Jadwal Kegiatan </h1>
                    <img src="" class="headerimg">
                    <form action="update_jadwal_kegiatan.php" method="post" name="">
                    <table border="0" width="600" align="center">
                        ...
                        <tr>
                            <td class="lead">ID Jenis Kegiatan</td>
                            <td>
                            <select name="id_jenis_kegiatan" class="form-control" >
                            <option value="<?php echo $kor[1]; ?>"><?php echo $kor[1]; ?></option>
                            <?php
                            include ("koneksi.php");
                        ...
                        <tr>
                            <td class="lead">ID Tema</td>
                            <td>
                            <select name="id_tema_kegiatan" class="form-control" >
                            <option value="<?php echo $kor[2]; ?>"><?php echo $kor[2]; ?></option>
                            <?php
                            include ("koneksi.php");
    
                            $kuery="select * from tema_kegiatan";
                            $hasil=mysqli_query($konek,$kuery) or die (mysqli_error($konek));
                            while($free = mysqli_fetch_array($hasil)){
                            $id = strip_tags($free['id']);
                            $tema_kegiatan = strip_tags($free['tema_kegiatan']);

                            echo "<option value='" .$id."'>".$tema_kegiatan. "</option>";
                        ...
                        <tr>
                            <td class="lead">Tanggal Mulai</td>
                            <td><input class="form-control" id="inputSuccess" type="date" name="tanggal_mulai" size="20" maxlength="50" value="<?php echo $kor[3]; ?>"/></td>
                        </tr>
                        <tr>
                            <td class="lead">Tanggal Selesai</td>
                            <td><input class="form-control" id="inputSuccess" type="date" name="tanggal_selesai" size="20" maxlength="50" value="<?php echo $kor[4]; ?>"/></td>
                        </tr>
                        <tr>
                            <td class="lead">ID Unit Kerja BPK</td>
                            <td>
                            <select name="id_unit_kerja_bpk" class="form-control" >
                            <option value=<?php echo $kor[5]; ?>><?php echo $kor[5]; ?></option>
                            <?php
                            include ("koneksi.php");
    
                            $kuery="select * from unit_kerja_bpk";
                            $hasil=mysqli_query($konek,$kuery) or die (mysqli_error($konek));
                            while($free = mysqli_fetch_array($hasil)){
                            $id = strip_tags($free['id']);
