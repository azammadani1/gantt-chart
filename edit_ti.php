<?php
  ...
  $cari="select * from unit_kerja_ti where id='$cid'";
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
            <div class="col-lg-12">
                <h1 align="center">Edit Data Unit Kerja TI </h1>
                    <img src="" class="headerimg">
                    <form action="update_ti.php" method="post" name="">
                    <table border="0" width="600" align="center">
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" id="inputSuccess" type="text" name="singkatan" size="20" maxlength="50" value="<?php echo $kor[2]; ?>"/></td>
                        </tr>
                        <tr>
                            <td class="lead">ID Unker Parent</td>
                            <td><input class="form-control" id="inputSuccess" type="text" name="id_unker_parent" size="20" maxlength="50" value="<?php echo $kor[3]; ?>"/></td>
                        </tr>
                        <tr>
                <td>&nbsp;</td>
            </tr>
