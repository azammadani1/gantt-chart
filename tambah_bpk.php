    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
            <div class="col-lg-12">
                <h1 align="center">Tambah Data Unit Kerja BPK</h1>
                <img src="" class="headerimg">
                <form action="simpan_bpk.php" method="post" name="">
                <table border="0" width="600" align="center">
                    ...
                    <tr>
                        ...
                        <td><input class="form-control" id="inputSuccess" type="text" name="lokasi_kegiatan" size="20" maxlength="30"/></td>
                    </tr>
                    <tr>
                        <td class="lead">Tingkat Eselon</td>
                        <td><input class="form-control" id="inputSuccess" type="text" name="tingkat_eselon" size="20" maxlength="15"/></td>
            </tr>
            <tr>
            <td>&nbsp;</td>
            </tr>
