    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
            <div class="col-lg-12">
                <h1 align="center">Tambah Tema Kegiatan</h1>
                <img src="" class="headerimg">
                <form action="simpan_tema_kegiatan.php" method="post" name="">
                <table border="0" width="600" align="center">
                    ...
                    <tr>
                        ...
                        <td><input class="form-control" id="inputSuccess" type="text" name="tema_kegiatan" size="20" maxlength="20"/></td>
                    </tr>
                    <tr>
                    <td>&nbsp;</td>
                    </tr>
