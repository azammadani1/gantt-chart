      ...
      <div id="content">
        ...
        <div id="page-wrapper">
            ...
            <div class="col-lg-12">
                ...
                <form action="simpan_jenis_kegiatan.php" method="post" name="">
                <table border="0" width="600" align="center">
                    ...
                    <tr>
                        ...
                        <td><input class="form-control" id="inputSuccess" type="text" name="jenis_kegiatan" size="20" maxlength="20"/></td>
                    </tr>
                    <tr>
                    <td>&nbsp;</td>
                    </tr>
