<?php
  ...
  $cari="select * from unit_kerja_bpk where id='$cid'";
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Unit Kerja:</h6>
                <a class="collapse-item active" href="data_bpk.php">BPK</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
            <div class="col-lg-12">
                <h1 align="center">Edit Data Unit Kerja BPK </h1>
                    <img src="" class="headerimg">
                    <form action="update_bpk.php" method="post" name="">
                    <table border="0" width="600" align="center">
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" id="inputSuccess" type="text" name="unit_kerja" size="20" maxlength="50" value="<?php echo $kor[1]; ?>"/></td>
                        </tr>
                        <tr>
                            <td class="lead">Lokasi Kegiatan</td>
                            <td><input class="form-control" id="inputSuccess" type="text" name="lokasi_kegiatan" size="20" maxlength="50" value="<?php echo $kor[2]; ?>"/></td>
                        </tr>
                        <tr>
                            <td class="lead">Tingkat Eselon</td>
                            <td><input class="form-control" id="inputSuccess" type="text" name="tingkat_eselon" size="20" maxlength="50" value="<?php echo $kor[3]; ?>"/></td>
                        </tr>
                        <tr>
                <td>&nbsp;</td>
            </tr>
