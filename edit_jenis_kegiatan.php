<?php
  ...
  $cari="select * from kegiatan where id='$cid'";
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        ...
        <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item active" href="data_jenis_kegiatan.php">Jenis Kegiatan</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
            <div class="col-lg-12">
                <h1 align="center">Edit Data Kegiatan </h1>
                    <img src="" class="headerimg">
                    <form action="update_jenis_kegiatan.php" method="post" name="">
                    <table border="0" width="600" align="center">
                        ...
                        <tr>
                            <td class="lead">Jenis Kegiatan</td>
                            <td><input class="form-control" id="inputSuccess" type="text" name="jenis_kegiatan" size="20" maxlength="50" value="<?php echo $kor[1]; ?>"/></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                        </tr>
