<?php
  ...
  $cari="select * from tema_kegiatan where id='$cid'";
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
            <div class="col-lg-12">
                <h1 align="center">Edit Tema Kegiatan </h1>
                    <img src="" class="headerimg">
                    <form action="update_tema_kegiatan.php" method="post" name="">
                    <table border="0" width="600" align="center">
                        ...
                        <tr>
                            <td class="lead">Tema Kegiatan</td>
                            <td><input class="form-control" id="inputSuccess" type="text" name="tema_kegiatan" size="20" maxlength="50" value="<?php echo $kor[1]; ?>"/></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                        </tr>
