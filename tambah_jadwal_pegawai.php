      ...
      <div id="content">
        ...
        <div id="page-wrapper">
            ...
            <div class="col-lg-12">
                ...
                <form action="simpan_jadwal_pegawai.php" method="post" name="">
                <table border="0" width="600" align="center">
                    <tr>
                        <td class="lead">ID</td>
                        <td><input class="form-control" id="inputSuccess" type="text" name="id" size="20" maxlength="30"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input class="form-control" id="inputSuccess" type="date" name="tanggal_pergi" size="20" maxlength="30"/></td>
                    </tr>
                    <tr>
                        <td class="lead">Tanggal Selesai</td>
                        <td><input class="form-control" id="inputSuccess" type="date" name="tanggal_balik" size="20" maxlength="15"/></td>
                    </tr>
