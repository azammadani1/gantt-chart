<?php
  ...
  $cari="select * from jadwal_kegiatan_pegawai where id='$cid'";
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
            <div class="col-lg-12">
                <h1 align="center">Edit Jadwal Pegawai </h1>
                    <img src="" class="headerimg">
                    <form action="update_jadwal_pegawai.php" method="post" name="">
                    <table border="0" width="600" align="center">
                        <tr>
                            <td class="lead">ID</td>
                            <td><input class="form-control" id="inputSuccess" type="text" name="id" size="20" maxlength="50" value="<?php echo $kor[0]; ?>"/></td>
                        </tr>
                        <tr>
                            <td class="lead">ID Pegawai</td>
                            <td>
                        ...
                        <tr>
                            <td class="lead">ID Jadwal Kegiatan</td>
                            <td>
                            <select name="id_jadwal_kegiatan" class="form-control" >
                            <option value="<?php echo $kor[2]; ?>"><?php echo $kor[2]; ?></option>
                            <?php
                            include ("koneksi.php");
    
                            $kuery="select * from jadwal_kegiatan";
                            $hasil=mysqli_query($konek,$kuery) or die (mysqli_error($konek));
                            while($free = mysqli_fetch_array($hasil)){
                            $id = strip_tags($free['id']);
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" id="inputSuccess" type="date" name="tanggal_pergi" size="20" maxlength="50" value="<?php echo $kor[3]; ?>"/></td>
                        </tr>
                        <tr>
                            <td class="lead">Tanggal Selesai</td>
                            <td><input class="form-control" id="inputSuccess" type="date" name="tanggal_balik" size="20" maxlength="50" value="<?php echo $kor[4]; ?>"/></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                        </tr>
