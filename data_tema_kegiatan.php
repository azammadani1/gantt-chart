      ...
      <li class="nav-item active">
        ...
        <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="data_tema_kegiatan.php">Tema Kegiatan</a>
      ...
      <div id="content">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row">
                    <div class="col-sm-6">
                       <h2 class="m-0 font-weight-bold text-primary">Tema Kegiatan</h2>
                    </div>
                    <div class="col-sm-6" align="right">
                        <a href="tambah_tema_kegiatan.php" class="btn btn-success">Tambah</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <tr align="center"> 
                      ...
                      <td>
                          <?php echo"<a href='edit_tema_kegiatan.php?id=$isi[0]' class='btn btn-success'>Edit</a>";?>
                          <?php echo"<a href='hapus_tema_kegiatan.php?id=$isi[0]' class='btn btn-danger'>Hapus</a>";?>
                      </td>
                    </tr>
                  </tbody>
                        <?php } ?>
